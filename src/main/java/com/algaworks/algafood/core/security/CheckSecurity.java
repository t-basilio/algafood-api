...
public @interface CheckSecurity {
    ...
    @interface Pedidos {
        ...
        @PreAuthorize("@algaSecurity.podePesquisarPedidos(#filtro.clienteId, #filtro.restauranteId)")       // Ou é responsavel do restaurante
        @Retention(RUNTIME)
        @Target(METHOD)
        ...
        @PreAuthorize("@algaSecurity.podeGerenciarPedidos(#codigoPedido)")       // Ou é responsavel do restaurante
        @Retention(RUNTIME)
        @Target(METHOD)
    ...
    @interface UsuarioGruposPermissoes {
        ...
        @PreAuthorize("@algaSecurity.podeEditarUsuariosGruposPrmissoes()")
        @Retention(RUNTIME)
        @Target(METHOD)
        @interface PodeEditar { }
