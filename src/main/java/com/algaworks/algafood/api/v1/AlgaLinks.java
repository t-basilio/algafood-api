...
public class AlgaLinks {
    ...
    public Link linkToPedidos(String rel){
        ...
        return new Link(UriTemplate.of(pedidosUrl,
                PAGINACAO_VARIABLES.concat(filtrosVariables)), rel);
    }
    ...
    public Link linkToRestauranteFormaPagamentoDesassociação(
    ...
    public Link linkToRestauranteResponsaveisDesassociacao(
