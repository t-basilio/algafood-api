...
public interface RestauranteControllerOpenApi {
    ...
    RestauranteModel atualizar(@ApiParam(value = "ID de um restaurante", example = "1", required = true)Long restauranteId,
                               @ApiParam(name = "corpo", value = "Representação de um restaurantes com os novos dados")
    ...
    void ativarMultiplos (@ApiParam(name = "corpo", value = "IDs dos restaurantes", required = true)
                                   List<Long> restaurantIds);

    @ApiOperation(value = "Inativa múltiplos restaurantes")
    @ApiResponses({
            @ApiResponse(code = 204, message = "Restaurantes inativados com sucesso")})
    void inativarMultiplos (@ApiParam(name = "corpo", value = "IDs dos restaurantes", required = true)
                                    List<Long> restaurantIds);
