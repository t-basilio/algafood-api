...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleValidacaoException (MethodArgumentNotValidException ex, HttpHeaders headers,
                                                            WebRequest request){
    ...
    protected ResponseEntity<Object> handleNoHandlerFoundException(NoHandlerFoundException ex, HttpHeaders headers,
            ...
            String detail = String.format("O recurso %s que voce tentou acessar, é inexistente",
                    ex.getRequestURL());
            Problem problem =  createProblemBiulder(status, problemType, detail)
    ...
    private ResponseEntity<Object> handleInvalidFormat(InvalidFormatException ex, HttpHeaders headers,
        ...
        String detail = String.format("A propriedade '%s' recebeu o valor de '%s', " +
                        "que é um tipo inválido. Corrija e informe um valor com o típo %s.",
