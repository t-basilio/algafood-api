...
public class CadastroRestauranteIT {
    ...
    public void setUp(){
        ...
        jsonRestauranteSemFrete = ResourceUtils.getContentFromResource(
                "/json/correto/incorreto/restaurante-new-york-barbecue-sem-frete.json");

        jsonRestauranteSemCozinha = ResourceUtils.getContentFromResource(
                "/json/correto/incorreto/restaurante-new-york-barbecue-sem-cozinha.json");

        jsonRestauranteComCozinhaInexistente = ResourceUtils.getContentFromResource(
                "/json/correto/incorreto/restaurante-new-york-barbecue-com-cozinha-inexistente.json");
